...
5. c1 pointing to class object whichever created to A class.
   ...
   3 rd – by using reflection api new instance method.
...
7. we go the field object which is refering to i, inside a A class.
8. f1.setInt(obj, 20); we need to set i value 20 in the obj pointing object.
   ...
   we wanted to one int value to i which is available in the obj.
