...
attrubutes to that newly created object, instead of this lenghty
process we can go for object class clone method return a 
duplicate object, copied object, but to use the object class
clone method we need to follow some conditions, straght away
...
shold use in the A only. M1 also subclass to object. M1 also
